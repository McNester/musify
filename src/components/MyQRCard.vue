    ...
    md:flex-row md:h-[20rem] md:items-end">
        ...
        <div class="flex flex-col justify-between items-center relative md:ml-auto md:mb-10 md:-mr-10">
            ...
            <div class="flex flex-col justify-center items-center md:flex-row md:w-[30%]">
                <img src="/imgSrc/googlePlay.png" class="scale-[0.5] md:scale-[.8] hover:scale-[0.55] active:scale-50 cursor-pointer">
                <img src="/imgSrc/appStore.png" class="scale-[0.5] md:scale-[.8] -mt-20 md:-mt-0 hover:scale-[0.55] active:scale-50 cursor-pointer">
            </div>
        </div>
    </div>
</template>
